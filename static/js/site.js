...
var insertUser = function (user){
    ...
    template.find('.name a.friendagonlink').html(user.screen_name + '<span><strong>' + user.location + '</strong><br/>' + user.description + '</span>');
    template.find('.name .friendagonlink').attr('href' ,'http://friendagon.com/'+user.screen_name + '/');
    template.find('.name .twitterlink').attr('href' ,'http://twitter.com/'+user.screen_name + '/');
    template.find('img.avatar').attr('src' ,user.profile_image_url);
